...
import fr.hostux.louis.koelouis.fragments.PlaylistFragment.OnListFragmentInteractionListener;
...
public class PlaylistRecyclerViewAdapter extends RecyclerView.Adapter<PlaylistRecyclerViewAdapter.ViewHolder> {
    ...
    public PlaylistRecyclerViewAdapter(List<Song> songs, OnListFragmentInteractionListener listener) {
        this.songs = songs;
